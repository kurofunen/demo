...
(window.onload = function () {
    ...
    左から右から文字割れ
    ========================================================================== */
    $('.slide_move').on('inview', function (event, isInView) {
        if (isInView) {
            $(this).addClass('active');
        } else {}
    });
    ...
    上から下からから文字割れ
    ========================================================================== */
    $('.updwn_move').on('inview', function (event, isInView) {
        if (isInView) {
            $(this).addClass('active');
        } else {}
    });
    /* ==========================================================================
        左からスーと出る
        ========================================================================== */
    $('.left_move').on('inview', function (event, isInView) {
        if (isInView) {
            $(this).addClass('active');
        } else {}
    });
    /* ==========================================================================
        上からスーと出る
        ========================================================================== */
    $('.top_move').on('inview', function (event, isInView) {
        if (isInView) {
            $(this).addClass('active');
        } else {}
    });
